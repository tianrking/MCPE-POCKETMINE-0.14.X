...
/* Whether to build pthreads as dynamic module */
/* #undef COMPILE_DL_PTHREADS */
...
/* Whether to build weakref as dynamic module */
/* #undef COMPILE_DL_WEAKREF */
